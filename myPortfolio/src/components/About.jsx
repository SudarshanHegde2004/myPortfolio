    ...
    <div>
      <div id="about-myself" className="mt-8 px-4 md:px-10">
        ...
        <p className="p-2 text-grey-400 font-semibold text-left mt-4">
         Currently, I am studying at Sambhram Institute of Technology, which is affiliated with Visvesvaraya Technological University. My fascination with technology began early on, and it has only grown as I have delved deeper into the world of computer science. I have a strong foundation in programming languages such as C++, C, Python, and Java, which have helped me develop a logical and analytical approach to problem-solving. My primary interests lie in Machine Learning, Deep Learning, Artificial Intelligence, and Cybersecurity, where I strive to explore how intelligent systems and secure solutions can address real-world challenges.
        </p>
        <p className="p-2 text-grey-400 font-semibold text-left mt-4">
          Alongside these domains, I have also gained experience in full-stack development, working with web technologies like HTML, CSS, JavaScript, React, and Tailwind CSS to create responsive and functional applications. This complements my broader expertise by enabling me to design end-to-end solutions that integrate both intelligence and usability.
        </p>
        <p className="p-2 text-grey-400 font-semibold text-left mt-4">
          In addition to my coursework, I actively seek out projects and opportunities that allow me to apply my knowledge in practical scenarios. I believe that hands-on experience is essential for mastering any discipline, and I am always eager to collaborate on innovative projects that have real impact. My time at Sambhram Institute of Technology has equipped me not only with technical skills, but also with the ability to work effectively in teams, communicate complex ideas clearly, and manage projects efficiently. I am deeply committed to advancing as a computer scientist and am enthusiastic about contributing to the tech community. Whether it is through developing intelligent models, advancing cybersecurity, or building intuitive interfaces, I am driven to make a meaningful impact in the field of technology.
          </p>
      </div>
